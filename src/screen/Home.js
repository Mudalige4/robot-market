...
export default function Home() {
    ...
    //set filtered robots list
    const [filteredRobotsList, setFilteredRobotsList] = useState([]);
    //set cart item
    ...
    function getMaterialList(){
        ...
        let uniqueRobots = [...new Set((robotsList.map(item => item.material)))]
    ...
    function onValueChangeValue(item) {
        setSelectedMaterial(item)

        //update robot
        let updateRobotList = [...robotsList]

        let filterdList = updateRobotList.filter(f => f.material === item)

        setFilteredRobotsList(filterdList)
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.body}>
                <ShoppingList onValueChangeValue={onValueChangeValue} selectedMaterial={selectedMaterial} isLoading={isLoading} robotsList={selectedMaterial ? filteredRobotsList : robotsList} onPressAddToCart={onPressAddToCart} materialList={getMaterialList()} />
            </View>
